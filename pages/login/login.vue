    ...
    <view class="login-box">
        ...
        <view class="uni-container">
            <uni-forms ref="form" validateTrigger="bind" :rules="rules" @submit="submit">
                <uni-forms-item left-icon="person" class="radius-5" name="username" labelWidth="35">
                    <input
                        ref="usernameInput"
                        @confirm="confirmForm('username', $event.detail.value)"
                ...
                <uni-forms-item left-icon="locked" class="icon-container radius-5" name="password" labelWidth="35">
                    <input
                        ref="passwordInput"
                        @confirm="confirmForm('password', $event.detail.value)"
                        class="uni-input-border"
